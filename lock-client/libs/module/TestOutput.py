...
class TestOutput:
	...
	def enable(self):
		...
		# event falling edge
		self.io_input.add_event_detect(IO.EDGE_RISING, lambda : dc.e.raise_event(self.event_name, {}) )
		
		self.io_input.add_event_detect(IO.EDGE_FALLING, lambda : logger.info("TEO: IO.EDGE_FALLING") )
		self.io_input.add_event_detect(IO.EDGE_RISING, lambda : logger.info("TEO: IO.EDGE_RISING") )
	...
	def action_callback(self, data={}):
		...
		# log
		logger.info("TEO: action input={}, output={}".format(self.io_input.input(), self.io_output.input()))
