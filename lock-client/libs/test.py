...
p8_17.add_event_detect(IOWrapper.EDGE_RISING, lambda pin: p30.io_chip.pn532Gpio.gpio_invert(p30.pin) )
...
p72.add_event_detect(IOWrapper.EDGE_FALLING, lambda: p9_12.output(1) or p31.io_chip.pn532Gpio.gpio_invert(p31.pin))
